...
function update_localstorage(parametros) {
    ...
    window.localStorage.setItem("embalalgem", parametros.embalagem);
...
$(function () {
    ...
    function atualizar(parametros) {
        ...
        window.setTimeout(function () {
            ...
            $('#valor-total').html(valortotal.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximunFractionDigits: 2 }));
